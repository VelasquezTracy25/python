...
# Find the most repeate character in the sentence

# Questions to ask: Are capitalized chars and spaces counted?
...
print(char_freq_sorted[0])  # return the first item of the sorts list
